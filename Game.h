...
private:
	...
	Board m_Board;// Indicate the board of this game (a copy)

	Player* m_SouthPlayer; // The South Player
	Player* m_NorthPlayer; // The North Player

	Side m_MovesThisTurn; //Indicate whose turn it is --- South side always moves first.
